...
add wave -noupdate -expand -group PLATCH_IFID /system_tb/DUT/CPU/DP/ifid/flushed_in
...
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/memWr
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/fwif/memRegWr
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/exMemRead
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/exMemWr
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/wbMemRead
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/wbRegWr
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/fwif/id_rs
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/fwif/id_rt
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/ex_rs
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/ex_rt
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/mem_rd
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/fwif/forwardData
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/wb_rd
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/forwardA
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/FWU/fw_if/forwardB
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/fwif/forwardR1
add wave -noupdate -group FWUNIT /system_tb/DUT/CPU/DP/fwif/forwardR2
add wave -noupdate /system_tb/DUT/CPU/DP/RF/regs
add wave -noupdate /system_tb/DUT/CPU/halt
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/branch
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/branch_neq
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/dhit
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/flush_idex
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/flush_ifid
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/flush_wb
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/flush_xmem
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/idex_rs
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/is_equal
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/jump
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/mwb_rd
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/pc_en
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/stall_idex
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/stall_ifid
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/stall_wb
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/stall_xmem
add wave -noupdate -group HAZARDUNIT /system_tb/DUT/CPU/DP/HZU/hzif/take_branch
...
add wave -noupdate -expand -group PCIF /system_tb/DUT/CPU/DP/PC/pcif/bubble
...
add wave -noupdate -expand -group PCIF /system_tb/DUT/CPU/DP/dpif/imemload
...
WaveRestoreCursors {{Cursor 1} {147821 ps} 0}
